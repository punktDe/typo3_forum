...
return [
	\TYPO3\CMS\Extbase\Domain\Model\FrontendUser::class => [
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\User\FrontendUser::class => \Mittwald\Typo3Forum\Domain\Model\User\FrontendUser::class
		]
	],
	\TYPO3\CMS\Extbase\Domain\Model\FrontendUserGroup::class => [
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\User\FrontendUserGroup::class => \Mittwald\Typo3Forum\Domain\Model\User\FrontendUserGroup::class
		]
	],
	...
	\Mittwald\Typo3Forum\Domain\Model\User\Userfield\AbstractUserfield::class => [
		...
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\User\Userfield\TyposcriptUserfield::class => \Mittwald\Typo3Forum\Domain\Model\User\Userfield\TyposcriptUserfield::class,
            \Mittwald\Typo3Forum\Domain\Model\User\Userfield\TextUserfield::class => \Mittwald\Typo3Forum\Domain\Model\User\Userfield\TextUserfield::class
		]
	],
	...
	\Mittwald\Typo3Forum\Domain\Model\Moderation\Report::class => [
		...
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\Moderation\UserReport::class => \Mittwald\Typo3Forum\Domain\Model\Moderation\UserReport::class,
            \Mittwald\Typo3Forum\Domain\Model\Moderation\PostReport::class => \Mittwald\Typo3Forum\Domain\Model\Moderation\PostReport::class
	...
	\Mittwald\Typo3Forum\Domain\Model\Format\AbstractTextParserElement::class => [
		...
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\Format\BBCode::class => \Mittwald\Typo3Forum\Domain\Model\Format\BBCode::class,
			\Mittwald\Typo3Forum\Domain\Model\Format\Smiley::class => \Mittwald\Typo3Forum\Domain\Model\Format\Smiley::class,
			\Mittwald\Typo3Forum\Domain\Model\Format\SyntaxHighlighting::class => \Mittwald\Typo3Forum\Domain\Model\Format\SyntaxHighlighting::class
	...
	\Mittwald\Typo3Forum\Domain\Model\Format\BBCode::class => [
		...
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\Format\QuoteBBCode::class => \Mittwald\Typo3Forum\Domain\Model\Format\QuoteBBCode::class,
            \Mittwald\Typo3Forum\Domain\Model\Format\ListBBCode::class => \Mittwald\Typo3Forum\Domain\Model\Format\ListBBCode::class
	...
	\Mittwald\Typo3Forum\Domain\Model\Forum\Topic::class => [
		...
		'recordType' => 0,
		'subclasses' => [
			\Mittwald\Typo3Forum\Domain\Model\Forum\ShadowTopic::class => \Mittwald\Typo3Forum\Domain\Model\Forum\ShadowTopic::class
		]
	],
